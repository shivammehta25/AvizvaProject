...
<head>
    ...
    <c:url var=“rjs” value=“/resources/js”></c:url>
	...
	<link rel="stylesheet" href="resources/css/navbar-fixed-top.css">
		...
		<div id="carousel1" class="carousel slide" data-ride="carousel" data-interval="3000">
			...
			<div class="carousel-inner">
				<div class="item active">
					<img alt="Gaming Collection" src="resources/images/slider1.jpg" style="width: 100%">
				...
				<div class="item">
					<img src="resources/images/slider2.jpg" alt="Gaming Hardwares" style="width: 100%">
					<div class="carousel-caption">
				...
				<div class="item">
					<img src="resources/images/slider3.jpg" alt="Gaming Peripherals" style="width: 100%">
					<div class="carousel-caption">
